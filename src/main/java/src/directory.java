        ...
        if (directory != null) {
            ...
            if (directory.isAbsolute()) {
                ...
                if (!directory.exists()) {
                    ...
                    new showDialog().notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "The directory already appears to exist\nPlease try again", "Accept");
                }
            } else {
                // If any of the conditions are false, display a message dialog to inform the user that the directory was not created and provide guidance on how to select a valid directory
                new showDialog().notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "It seems that the directory is not absolute\nPlease try again", "Accept");
            }
        } else {
            // If any of the conditions are false, display a message dialog to inform the user that the directory was not created and provide guidance on how to select a valid directory
            new showDialog().notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "The directory appears to be null\nPlease try again", "Accept");
        }
    }
            ...
            if (directory.exists()) {
                if (directory.isAbsolute()) {
                    if (java.awt.Desktop.getDesktop().isSupported(java.awt.Desktop.Action.OPEN)) {
                        ...
                        directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Directory opening is not supported on this operating system\nPlease try a different device", "Accept");
                    }
                } else {
                    directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Unable to open the pull directory because this is not an absolute directory\nPlease try again", "Accept");
                }
            } else {
                directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Unable to open the extract directory because it does not exist\nPlease try again", "Accept");
            }
        } else {
            directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Unable to open extraction directory because extraction directory is null\nPlease try again", "Accept");
        }
    }
        ...
        if (directory != null) {
            if (directory.exists()) {
                if (directory.isAbsolute()) {
                    ...
                    if (this.OShowDialog.confirmation(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "You are about to delete the extraction directory\nDo you want to delete it?", new String[]{"Erase", "Cancel"})) {
                        javax.swing.SwingWorker<Void, String> worker = new javax.swing.SwingWorker<>() {
                            ...
                            protected Void doInBackground() {
                                ...
                                run.main.window.getOutputText().setForeground(new java.awt.Color(220, 74, 74));
                            ...
                            protected void process(java.util.List<String> chunks) {
                                for (String message : chunks) {
                                    run.main.window.setOutputText(message);
                                }
                            }
                            ...
                            protected void done() {
                                ...
                                if (!directory.this.OExtractFile.getExtractionPathTwo().exists()) {
                                    directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/done.png"))), "The extraction path was successfully deleted", "Accept");
                                } else {
                                    directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "The extraction path could not be deleted correctly\nPlease try again", "Accept");
                                }
                            }
                        };
                    ...
                    directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Unable to delete extraction directory because this is not an absolute directory\nPlease try again", "Accept");
                }
            } else {
                directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Unable to delete extraction directory because it does not exist\nPlease try again", "Accept");
            }
        } else {
            directory.this.OShowDialog.notify(new javax.swing.ImageIcon(java.util.Objects.requireNonNull(getClass().getResource("/resources/images/failed.png"))), "Unable to delete extraction directory because it is null\nPlease try again", "Accept");
        }
    }
