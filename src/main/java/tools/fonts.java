...
public class fonts {
    ...
    public java.awt.Font load(String dir, String name, String format, int height) throws resource.showException {
        ...
        try {
            ...
            throw new resource.showException("(Exception): Failed to load required font. class name: " + this.getClass());
        }
        return font;
    }
}